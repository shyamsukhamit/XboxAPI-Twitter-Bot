...
//=================================================================================
    ...
    */
    public function __construct( $config = array() )
    {
        ...
        $this->config = array_merge(
            array(
                ...
                'curl_cainfo'                => dirname( BASEPATH ) . '/cacert.pem',
                'curl_capath'                => dirname( BASEPATH ),
    ...
    public function set_user_agent()
    {
        ...
        $useragent = 'Twitter oAuth by djekl Developments';
...
//=================================================================================
    ...
    */
    ...
    {
        $this->config['timestamp'] = ( !$this->config['force_timestamp'] ? time() : $this->config['timestamp'] );
    }
    //------------------------------------------------------------------
    ...
    */
    private function curlit()
    {
        ...
        if ( isset( $this->config['prevent_request'] ) && $this->config['prevent_request'] === TRUE )
            return;
...
class tweet_lib extends twitter_oAuth {
...
//=================================================================================
    ...
    {
        // default configuration options
        $init_config = array_merge(
            array(
                'user_agent'        => 'XboxAPI tweet script',                                  // our custom useragent string
     ...
     * public new_tweet()
     */
    public function new_tweet( $tweet = FALSE, $in_reply_to = FALSE )
    {
        // Make the API call
        if (!$in_reply_to)
        {
     ...
     * public mentions()
     */
    public function mentions( $since_id = 0 )
    {
        // Make the API call
        $this->request(
            'GET',
